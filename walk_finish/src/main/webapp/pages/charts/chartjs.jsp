 ...
 <!-- ----------------------------오른쪽 사이드바 부분 --------------------------------------------------------- -->     
      ...
      <div id="right-sidebar" class="settings-panel">
        ...
        <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="todo-tab" data-toggle="tab" href="#todo-section" role="tab" aria-controls="todo-section" aria-expanded="true">오늘의 할일</a>
          </li>
            ...
            <div class="add-items d-flex px-3 mb-0">
              <form class="form w-100">
                <div class="form-group d-flex">
                  ...
                  <button type="submit" class="add btn btn-primary todo-list-add-btn" id="add-task">할일 추가</button>
                </div>
              </form>
            </div>
