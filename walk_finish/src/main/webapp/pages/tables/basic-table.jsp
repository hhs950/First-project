<%@page import="Model_Rank.RankVO"%>
<%@page import="java.util.ArrayList"%>
<%@page import="Model_Rank.RankDAO"%>
...
<%
	...
	ArrayList<RankVO> list =dao.donateRank();
	ArrayList<RankVO> list1 =dao.stepRank();
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">보유 걸음 수 랭킹</h4>                  
                      ...
                      <tbody>
                        <%
							for(int i=0; i<list1.size();i++){%>
               				 <tr>
               				 	<td><%= list1.get(i).getRank_step() %></td>
               				 	<td>**<%= list1.get(i).getId().substring(2)%></td>
                 	 			<td><%= list1.get(i).getStep_all() %></td>     
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">기부걸음수 랭킹</h4>                  
                  <div class="table-responsive">
                      ...
                      <tbody>
                           ...
                           <%
							for(int i=0; i<list.size();i++){%>
               				 ...
               				 <tr>
               				 	<td><%= list.get(i).getRank_donate() %></td>
               				 	<td>**<%= list.get(i).getId().substring(2)%></td>
                 	 			<td><%= list.get(i).getDonate_all() %></td>     
