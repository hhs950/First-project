            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">                 
                  ...
                  <%if(vo!=null){%> <button style="float: right"  class="btn btn-primary pull-right "><a style="color:#ffffff" href="board.jsp">글쓰기</a></button>
                  <%}else{%>
                  <h4><글을 쓰시려면 로그인을 해주세요></h4>                   
                  <%} %>                  
                  <!--날짜순 정렬하려고 vo2 만듬 / dao의 showWrite()수정  -->
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                       ...
                       <td align="center"><%= list.get(i).getM_date()%></td>
                     </tr> 
                     <%}%>
                     </tbody> 
                </table>                    
